...
public class PetApi {
    ...
    @GetMapping
    public HttpEntity<PagedModel<PetResource>> search(PetSearchCriteria criteria, Fields fields, Pageable pageable, PagedResourcesAssembler<Pet> assembler) {
    ...
    @GetMapping("/{key}")
    public PetResource find(@PathVariable String key, Fields fields) {
    ...
    @PostMapping
    public PetResource create(Fields fields, @RequestBody PetResource resource) {
    ...
    @PutMapping("/{key}")
    public PetResource update(@PathVariable String key, Fields fields, @RequestBody PetResource resource) {
